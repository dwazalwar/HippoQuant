...
def LoadHippocampusData(root_dir, y_shape, z_shape):
    ...
    for f in images:
        ...
        # ANSWER: Casting labels to int is necessary because segmentation labels typically represent categorical values (e.g., classes or regions), 
        # whereas image data is usually continuous
