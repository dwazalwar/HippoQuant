...
def create_report(inference, header, orig_vol, pred_vol):
    ...
    draw.multiline_text((10, 90),
                        ...
                        f"Posterior Volume (Red) : {inference['posterior']}\n"
                        f"Anterior Volume (Green): {inference['anterior']}\n"
    ...
    draw.text((10, 250), f"Showing slices at {slice_nums[0]}, {slice_nums[1]}, {slice_nums[2]}", (255, 255, 255), font=header_font)
...
def get_series_for_inference(path):
    ...
    # Add dicom file with series description being "HippoCrop" and Modality is "MR"
    series_for_inference = [dcm_file for dcm_file in dicoms if dcm_file.SeriesDescription == 'HippoCrop' and dcm_file.Modality == 'MR']
...
if __name__ == "__main__":
    ...
    report_save_path = os.path.join('.', 'report.dcm')
    ...
    os_command("storescu 127.0.0.1 4242 -v -aec HIPPOAI +r +sd /home/workspace/src/report.dcm")
